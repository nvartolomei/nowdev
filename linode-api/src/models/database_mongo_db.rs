...
/// DatabaseMongoDb : Managed MongoDB Databases object.
...
pub struct DatabaseMongoDb {
    ...
    pub hosts: Option<Box<crate::models::DatabaseMongoDbHosts>>,
    ...
    pub replica_set: Option<Option<String>>,
    ...
    #[serde(rename = "storage_engine", skip_serializing_if = "Option::is_none")]
