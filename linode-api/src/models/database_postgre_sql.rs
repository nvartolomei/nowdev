...
/// DatabasePostgreSql : Managed PostgreSQL Databases object.
...
pub struct DatabasePostgreSql {
    ...
    pub hosts: Option<Box<crate::models::DatabasePostgreSqlHosts>>,
    ...
    #[serde(rename = "replication_type", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "replication_commit_type",
    ...
    pub updates: Option<Box<crate::models::DatabaseUpdates>>,
}

impl DatabasePostgreSql {
    /// Managed PostgreSQL Databases object.
    pub fn new() -> DatabasePostgreSql {
        DatabasePostgreSql {
            id: None,
            label: None,
            r#type: None,
...
impl Default for ReplicationCommitType {
    fn default() -> ReplicationCommitType {
        Self::On
    }
}
