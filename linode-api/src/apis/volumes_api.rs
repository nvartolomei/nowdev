...
/// struct for typed errors of method [`attach_volume`]
...
pub async fn attach_volume(
    ...
    volume_id: i32,
    attach_volume_request: crate::models::AttachVolumeRequest,
) -> Result<crate::models::GetLinodeVolumes200ResponseDataInner, Error<AttachVolumeError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&attach_volume_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AttachVolumeError> =
...
pub async fn clone_volume(
    configuration: &configuration::Configuration,
    volume_id: i32,
    clone_volume_request: crate::models::CloneVolumeRequest,
) -> Result<crate::models::GetLinodeVolumes200ResponseDataInner, Error<CloneVolumeError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&clone_volume_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CloneVolumeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::GetLinodeVolumes200ResponseDataInner, Error<CreateVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_volume(
    configuration: &configuration::Configuration,
    volume_id: i32,
) -> Result<serde_json::Value, Error<DeleteVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn detach_volume(
    configuration: &configuration::Configuration,
    volume_id: i32,
) -> Result<serde_json::Value, Error<DetachVolumeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::GetLinodeVolumes200ResponseDataInner, Error<GetVolumeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_volumes(
    ...
    page: Option<i32>,
    page_size: Option<i32>,
) -> Result<crate::models::GetLinodeVolumes200Response, Error<GetVolumesError>> {
    let local_var_configuration = configuration;
...
pub async fn resize_volume(
    configuration: &configuration::Configuration,
    volume_id: i32,
    resize_volume_request: crate::models::ResizeVolumeRequest,
) -> Result<crate::models::GetLinodeVolumes200ResponseDataInner, Error<ResizeVolumeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::GetLinodeVolumes200ResponseDataInner, Error<UpdateVolumeError>> {
    let local_var_configuration = configuration;
